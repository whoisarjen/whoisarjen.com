...
Ale jest jedno „ale”: **ten komponent działa dziś świetnie**. Użytkownicy lubią nawigację. Kod da się utrzymywać. Te 50 commitów nie poszło na marne — to był po prostu proces.
...
Ja z przyszłości rozumiem, co się zmieniło, bez czytania diffów.
...
### 5. Śledź rotację w komponentach
...
Komponenty o wysokiej rotacji zasługują na dodatkową uwagę — albo je uprość, albo zainwestuj w testy.
