...
summary: "Nasz cache na Redisie ciągle zrywał połączenia TLS, kładąc całą warstwę cache'owania. Po benchmarku, który omal nie wysłał nas w złą stronę, przenieśliśmy się na PostgreSQL — ta sama wydajność, zero dropów, o jeden serwis mniej do utrzymania."
